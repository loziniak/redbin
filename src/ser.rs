...
mod tests {
    ...
    fn test_seq() {
        ...
        // rust-redbin-helper reduce [-2 299 66666 [5 6] yes 122234.23425 12.5 "aa" "ą" "💖" #"a" #"ą" #{CAFE}]
        let expected = &[];
        
        assert_eq!(to_bytes(&i).unwrap(), expected);

        assert_eq!(to_bytes::<()>(&()).unwrap(), &[0x52, 0x45, 0x44, 0x42, 0x49, 0x4E, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00]);
        assert_eq!(to_bytes::<Option<i32>>(&None).unwrap(), &[0x52, 0x45, 0x44, 0x42, 0x49, 0x4E, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00]);
        assert_eq!(to_bytes::<Option<i32>>(&Some(123)).unwrap(), &[0x52, 0x45, 0x44, 0x42, 0x49, 0x4E, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x0B, 0x00, 0x00, 0x00, 0x7B, 0x00, 0x00, 0x00]);
    }
